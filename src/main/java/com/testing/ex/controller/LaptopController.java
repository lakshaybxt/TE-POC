...
public class LaptopController {
     ...
     */
    @Operation(summary = "List products for authenticated user", description = "Returns a paginated list of products for the current user/tenant")
    @GetMapping
     ...
     */
    @Operation(summary = "Create product", description = "Create a new product for the authenticated user")
    @PostMapping
     ...
     */
    @Operation(summary = "Update product", description = "Update a product owned by the authenticated user")
    @PutMapping(path = "/{id}")
     ...
     */
    @Operation(summary = "Delete product", description = "Delete a product owned by the authenticated user")
     ...
     */
    @Operation(summary = "Get product by id", description = "Get single product by id for the authenticated user (response is encrypted)")
    @GetMapping(path = "/{id}")
     ...
     */
    @Operation(summary = "Decrypt product JSON", description = "Decrypt an encrypted product JSON string and return DTO")
    @PostMapping(path = "/decrypt")
    public ResponseEntity<ProductResponse> decryptMessage(
            @RequestBody String encryptedMessage
    ) {
        try {
            ProductResponse responseDto = encryptionUtils.decryptJson(encryptedMessage, ProductResponse.class);
